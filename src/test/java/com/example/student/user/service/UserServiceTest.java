...
//
//        when(userRepository.findUserById(user.getFirebaseId())).thenReturn(Optional.empty());
...
//        user.setName("test-nika");
//
//        when(userRepository.findUserById(user.getFirebaseId())).thenReturn(Optional.of(new TribeUser()));
//        when(userRepository.getUserByEmail(user.getEmail())).thenReturn(Optional.empty());
//        // Act
//        userService.signUp(user);
//        System.out.println("test");
